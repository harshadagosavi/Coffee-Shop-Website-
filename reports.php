...
$payment_revenue = $conn->query("SELECT payment_method, SUM(total) as revenue FROM orders WHERE status = 'confirmed' GROUP BY payment_method");

// Get monthly revenue for the last 6 months
$monthly_revenue = $conn->query("
    SELECT DATE_FORMAT(order_date, '%b %Y') as month, SUM(total) as revenue 
    FROM orders 
...
<head>
    ...
    <title>Reports - Coffee Shop Admin</title>
...
<body>
    ...
    <nav class="mobile-navbar navbar navbar-dark d-md-none p-3">
        <div class="container-fluid">
            ...
            <span class="navbar-brand ms-2">Reports & Analytics</span>
        </div>
    </nav>
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">View business insights and statistics</p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header bg-white border-0">
                            <h5 class="mb-0">Payment Method Revenue</h5>
                        </div>
                        <div class="card-body">
            ...
            <?php if(!empty($monthly_revenue_array)): ?>
            <div class="row">
    ...
    <script>
        ...
        new Chart(paymentCtx, {
            ...
            data: {
                labels: [<?php 
                    $payment_revenue->data_seek(0);
                    while($payment = $payment_revenue->fetch_assoc()) { 
